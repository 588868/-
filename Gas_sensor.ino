 ...
 * function:ignite a lighter. Then the sensor detects the gas emitted. Thus, 
 * the LED on the gas sensor and that attached to pin 13 on the arduino Uno 
...
const int digitalPin=12;  //the D0 attach to pin7
int Astate=0;
boolean  Dstate=0;
void setup() 
{
